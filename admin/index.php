...
<div class="flex gap-3 mb-6" style="flex-wrap:wrap;align-items:flex-start">
  ...
  <div class="card" style="flex:1;min-width:260px">
    <div class="card-head"><h3>Top Tracks</h3><a href="tracks.php" class="btn btn-sm btn-secondary">All →</a></div>
...
<div class="flex gap-3 mb-6" style="flex-wrap:wrap;align-items:flex-start">
  ...
  <!-- Recent Posts -->
  <div class="card" style="flex:2;min-width:300px">
    <div class="card-head"><h3>Recent Posts</h3><a href="posts.php" class="btn btn-sm btn-secondary">All →</a><a href="posts.php?action=new" class="btn btn-sm btn-primary">+ New</a></div>
    <div class="tbl-wrap">
      <table>
  ...
  <div class="card" style="flex:1;min-width:240px">
    <div class="card-head"><h3>New Subscribers</h3><a href="subscribers.php" class="btn btn-sm btn-secondary">All →</a></div>
    <div class="card-body" style="padding:0">
...
<div class="card mb-6">
  ...
  <div class="card-body flex gap-2 flex-wrap">
    ...
    <a href="appearance.php"              class="btn btn-md btn-secondary">Customize</a>
    <a href="monetization.php"            class="btn btn-md btn-secondary">Ads</a>
    <a href="analytics.php"              class="btn btn-md btn-secondary">Analytics</a>
  </div>
</div>
