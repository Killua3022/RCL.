...
<aside class="adm-sidebar">
  ...
  <nav class="adm-nav">
    ...
    <a class="adm-nav-item" href="music.php" target="_blank">
    ...
    <a class="adm-nav-item" href="index.php" target="_blank">
...
<div class="adm-main">
  ...
  <div class="adm-topbar">
    ...
    <div class="adm-topbar-right">
      <a href="music.php" target="_blank" class="btn btn-ghost btn-sm">↗ View Page</a>
