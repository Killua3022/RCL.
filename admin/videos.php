...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$err && $title) {
        if ($id) {
            ...
            header('Location: videos.php?msg=' . urlencode("Video updated: $title"));
        } else {
            ...
            header('Location: videos.php?msg=' . urlencode("Video added: $title"));
        }
        exit;
    }
...
if (isset($_GET['delete'])) {
    ...
    header('Location: videos.php?msg=Video+deleted');
    exit;
}
...
if (isset($_GET['feature'])) {
    ...
    header('Location: videos.php?msg=Featured+video+updated');
    exit;
}
...
<div class="card mb-6">
  <div class="card-head">
    ...
    <a href="videos.php" class="btn btn-sm btn-secondary">← Back</a>
  </div>
  <div class="card-body">
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="flex gap-2 mt-4">
        ...
        <a href="videos.php" class="btn btn-lg btn-secondary">Cancel</a>
      </div>
    </form>
  </div>
</div>
