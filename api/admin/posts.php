...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title) {
        if ($id) {
            ...
            header('Location: /admin/posts?msg=' . urlencode("Post updated: $title"));
        } else {
            ...
            header('Location: /admin/posts?msg=' . urlencode("Post created: $title"));
        }
        exit;
    }
...
if (isset($_GET['delete'])) {
    ...
    header('Location: /admin/posts?msg=Post+deleted');
    exit;
}
...
<div class="card mb-6">
  <div class="card-head">
    ...
    <a href="/admin/posts" class="btn btn-sm btn-secondary">← Back</a>
  </div>
  <div class="card-body">
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="flex gap-2 mt-4">
        ...
        <a href="/admin/posts" class="btn btn-lg btn-secondary">Cancel</a>
      </div>
    </form>
  </div>
</div>
